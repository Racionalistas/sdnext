...
bash webui.sh \
  --api --listen --port 7860 --debug --use-cuda --models-dir /mnt/models --skip-version-check --skip-torch-cuda-test --skip-python-version-check \
  ...
  --api-log --log sdnext.log --quick --enable-extensions controlnet &
WEBUI_PID=$!
